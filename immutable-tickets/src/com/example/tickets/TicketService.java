...
public class TicketService {
    ...
    public IncidentTicket createTicket(String id, String reporterEmail, String title) {
        ...
        // Move validation to Builder (cleaner design)
    ...
    public IncidentTicket escalateToCritical(IncidentTicket oldTicket) {
        ...
        // Create NEW ticket instead of mutating
        List<String> updatedTags = new ArrayList<>(oldTicket.getTags());
        updatedTags.add("ESCALATED");

        return oldTicket.toBuilder()
                .priority("CRITICAL")
                .tags(updatedTags)
                .build();
    }

    public IncidentTicket assign(IncidentTicket oldTicket, String assigneeEmail) {
